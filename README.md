...
1. **Access Pokémon Showdown**
   ...
   ![Screenshot of Pokémon Showdown homepage](figs/showdown.png)
...
2. **Set Up Your Account**
   ...
   ![A screenshot showing the username selection dialog box on Pokémon Showdown](figs/username.png)
...
3. **Import the Sample Team**
   ...
   ![A screenshot of the Teambuilder interface with the "Import from text or URL" option highlighted and a text box for pasting the team](figs/teambuilder.png)
   ![A screenshot of the Teambuilder interface with the "Import from text or URL" option highlighted and a text box for pasting the team](figs/teambuilder2.png)
...
4. **Initiate the Challenge**
   ...
   ![A screenshot showing the "Find a user" interface with "NeurIPS2024" entered in the search box and the challenge options displayed](figs/challenge.png)
